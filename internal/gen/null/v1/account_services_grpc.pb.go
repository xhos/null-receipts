...
func (UnimplementedAccountServiceServer) AddAccountAlias(context.Context, *AddAccountAliasRequest) (*AddAccountAliasResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddAccountAlias not implemented")
}
func (UnimplementedAccountServiceServer) RemoveAccountAlias(context.Context, *RemoveAccountAliasRequest) (*RemoveAccountAliasResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveAccountAlias not implemented")
}
func (UnimplementedAccountServiceServer) SetAccountAliases(context.Context, *SetAccountAliasesRequest) (*SetAccountAliasesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetAccountAliases not implemented")
}
func (UnimplementedAccountServiceServer) FindAccountByAlias(context.Context, *FindAccountByAliasRequest) (*FindAccountByAliasResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FindAccountByAlias not implemented")
}
func (UnimplementedAccountServiceServer) MergeAccounts(context.Context, *MergeAccountsRequest) (*MergeAccountsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MergeAccounts not implemented")
}
