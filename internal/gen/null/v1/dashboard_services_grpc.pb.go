...
func (UnimplementedDashboardServiceServer) GetMonthlyComparison(context.Context, *GetMonthlyComparisonRequest) (*GetMonthlyComparisonResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMonthlyComparison not implemented")
}
func (UnimplementedDashboardServiceServer) GetTopCategories(context.Context, *GetTopCategoriesRequest) (*GetTopCategoriesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTopCategories not implemented")
}
...
func (UnimplementedDashboardServiceServer) GetFinancialSummary(context.Context, *GetFinancialSummaryRequest) (*GetFinancialSummaryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFinancialSummary not implemented")
}
func (UnimplementedDashboardServiceServer) GetCategorySpendingComparison(context.Context, *GetCategorySpendingComparisonRequest) (*GetCategorySpendingComparisonResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCategorySpendingComparison not implemented")
}
